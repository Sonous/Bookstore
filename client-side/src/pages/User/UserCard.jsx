  ...
  return (
    <div>
        ...
        <section className="userPage">
            <div className="relative bg-center w-full bg-cover h-[500px] bg-[url('https://png.pngtree.com/thumb_back/fh260/background/20230526/pngtree-an-old-bookcase-in-a-library-image_2642908.jpg')] rounded-xl flex lg:pl-24 md:pl-8 sm:pl-0">
