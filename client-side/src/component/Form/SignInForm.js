  ...
  return (
    <form className="sign-in-form" onSubmit={handleSubmit}>
      ...
      <div className="heading">
        ...
        <a href="#" onClick={toggleMode} className="toggle">Đăng ký</a>
      </div>

      {error && <p style={{ fontSize: '0.85rem', border: '1px solid #bbb', padding: '10px', borderRadius: '5px' }}>{error}</p>} 
      ...
      <div className="actual-form">
        ...
        <p className="text">
        Quên mật khẩu hoặc thông tin đăng nhập của bạn? <a href="#" className="toggle" onClick={onGetHelpClick}>Nhận trợ giúp</a>
        </p>
      </div>
    </form>
  );
