...
export const ReviewCard = ({ img, date, title, rating, review, price }) => {
  return (
    ...
    <div className="space-y-2 p-3 flex-grow">
      <div className="items-center border-b border-blue-500">
        ...
        <h1 className="line-clamp-2 font-bold text-md text-secondary text-center xl:text-right">{date}</h1>
      </div>
      <div className="flex items-center gap-2 opacity-70 justify-center">
        ...
        <div className="items-center justify-between py-3">
          <p className="text-xl font-bold text-primary">{price}đ</p>
        </div>
      </div>
